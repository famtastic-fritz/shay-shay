...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from shay_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SHAY_OVERLAYS
        overlay = SHAY_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify shay doctor recognizes Xiaomi env vars."""
