...
Used by ``shay kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``shay_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Shay-Shay board.
...
def _profile_author() -> str:
    """Mirror of ``shay_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("SHAY_PROFILE")
