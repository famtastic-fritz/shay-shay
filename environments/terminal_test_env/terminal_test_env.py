...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Shay-Shay"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Shay-Shay",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Shay-Shay",
    },
    {
...
class TerminalTestEnv(ShayAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/shay-shay/.env.
        """
