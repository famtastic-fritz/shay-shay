...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateShay-Shay: "Mettre à jour Shay-Shay",
    updatingShay-Shay: "Mise à jour de Shay-Shay…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Shay-Shay (parité avec `shay plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.shay/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.shay/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.shay/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Shay-Shay Achievements",
      subtitle:
        "Badges Shay-Shay à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Shay-Shay en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Shay-Shay davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Shay-Shay détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Shay-Shay analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Shay-Shay ☤",
    },
  },
  kanban: {
