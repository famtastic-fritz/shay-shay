...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateShay-Shay: "Shay-Shay aktualisieren",
    updatingShay-Shay: "Shay-Shay wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shay-Shay-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `shay plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.shay/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.shay/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.shay/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Shay-Shay-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Shay-Shay-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Shay-Shay mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Shay-Shay ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Shay-Shay scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
