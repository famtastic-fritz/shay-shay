  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Shay-Shay community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Shay-Shay &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Shay-Shay?{' '}
        <a
          href="https://github.com/NousResearch/shay-shay/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
