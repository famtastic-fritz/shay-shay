"""Tests for the interactive session browser (`shay sessions browse`).
...
from shay_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """shay sessions browse should be parseable."""
        from shay_cli.main import main as _main_entry
