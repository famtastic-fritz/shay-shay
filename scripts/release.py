...
VERSION_FILE = REPO_ROOT / "shay_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+shay-shay-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shay@nousresearch.com": "NousResearch",
    ...
    "shay@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (SHAY_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (SHAY_HOME inject)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "shay@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/shay-shay",
    ...
    lines.append(f"# Shay-Shay v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Shay-Shay. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Shay-Shay Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Shay-Shay Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Shay-Shay v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Shay-Shay v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Shay-Shay v{new_version} ({calver_date})' "
