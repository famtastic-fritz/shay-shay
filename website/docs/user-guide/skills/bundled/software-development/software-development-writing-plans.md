...
| Version | `1.1.0` |
| Author | Shay-Shay (adapted from obra/superpowers) |
| License | MIT |
...
> **For Shay-Shay:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Shay-Shay tools to understand the project:
