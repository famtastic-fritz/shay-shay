...
const STORAGE_KEY = "shay-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `shay_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "shay-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-shay-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-shay-theme-font", "true");
