...
| | |
|---|---|
| Source | Optional — install with `shay skills install official/health/neuroskill-bci` |
...
Connect Shay-Shay to a running [NeuroSkill](https://neuroskill.com/) instance to read
