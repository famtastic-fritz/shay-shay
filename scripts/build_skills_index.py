#!/usr/bin/env python3
"""Build the Shay-Shay Skills Index — a centralized JSON catalog of all skills.
...
`shay skills search/install` can use it without hitting the GitHub API.
...
# Ensure SHAY_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Shay-Shay Skills Index...", flush=True)
