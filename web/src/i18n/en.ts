...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateShay-Shay: "Update Shay-Shay",
    updatingShay-Shay: "Updating Shay-Shay…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Shay-Shay plugins (`shay plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.shay/plugins/?",
    removeHint: "Only user-installed plugins under ~/.shay/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.shay/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Shay-Shay badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Shay-Shay session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Shay-Shay more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Shay-Shay sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Shay-Shay is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
