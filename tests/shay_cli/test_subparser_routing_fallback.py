...
The main() function in shay_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `shay -c model`
...
def _build_parser():
    """Build a minimal replica of the shay top-level parser."""
