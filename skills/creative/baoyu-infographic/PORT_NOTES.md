...
|--------|----------|--------|
| Metadata namespace | `openclaw` | `shay` |
...
| File operations | Bash commands | Shay-Shay file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Shay-Shay-specific adaptations.
