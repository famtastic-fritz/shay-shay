...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    DEFAULT_REPLY_PREFIX = "⚕ *Shay-Shay*\n────────────\n"
    
    # Default bridge location relative to the shay-shay install
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._session_path: Path = Path(config.extra.get(
            "session_path",
            get_shay_dir("platforms/whatsapp/session", "whatsapp/session")
        ))
        ...
        try:
            ...
            if data.get("status") != "connected":
                ...
                for attempt in range(15):
                    ...
                    print(f"[{self.name}]   If session expired, re-pair: shay whatsapp")
