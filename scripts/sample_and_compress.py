...
DEFAULT_DATASETS = [
    ...
    "NousResearch/shay-shay-megascience-sft1",
    "NousResearch/Shay-Shay-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Shay-Shay-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-shay-shay"
]
