...
class TestRunJobTerminalCwd:
    ...
    def _install_stubs(monkeypatch, observed: dict):
        ...
        # Bypass the real provider resolver — it reads ~/.shay and credentials.
        from shay_cli import runtime_provider as _rtp
        monkeypatch.setattr(
            _rtp,
        ...
        # run_job calls load_dotenv(~/.shay/.env, override=True), which will
