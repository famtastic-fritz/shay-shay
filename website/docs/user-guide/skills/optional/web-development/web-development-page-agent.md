...
- User wants **Shay-Shay itself to drive a browser** → use Shay-Shay' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
