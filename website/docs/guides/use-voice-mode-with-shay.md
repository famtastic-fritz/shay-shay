---
sidebar_position: 8
title: "Use Voice Mode with Shay-Shay"
description: "A practical guide to setting up and using Shay-Shay voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Shay-Shay
...
- you want Shay-Shay sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Shay-Shay.
...
## Step 1: make sure normal Shay-Shay works first
...
4. Shay-Shay transcribes and responds
...
- asking Shay-Shay to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Shay-Shay loop.

## Tuning CLI behavior

### Silence threshold

If Shay-Shay starts/stops too aggressively, tune:
...
Shay-Shay stays a normal chat bot, but can speak replies.
...
- you want Shay-Shay to function like a portable research or ops assistant
...
Shay-Shay joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Shay-Shay detects speech boundaries
- transcripts are posted in the associated text channel
- Shay-Shay responds in text and audio
...
1. get text Shay-Shay working
2. install `shay-shay[voice]`
