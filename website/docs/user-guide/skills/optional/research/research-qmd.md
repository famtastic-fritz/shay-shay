...
| | |
|---|---|
| Source | Optional — install with `shay skills install official/research/qmd` |
...
Shay-Shay via the native MCP client. This is the preferred
...
Then configure Shay-Shay to connect via HTTP:
