# Shay-Shay Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.shay/plugins/shay-achievements/state.json` (existing unlock state)
  - `~/.shay/plugins/shay-achievements/scan_snapshot.json` (new)
  - `~/.shay/plugins/shay-achievements/scan_checkpoint.json` (new)
