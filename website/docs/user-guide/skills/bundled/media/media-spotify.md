...
Control the user's Spotify account via the Shay-Shay Spotify toolset (7 tools). Setup guide: https://shay-shay.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `shay auth spotify` again.
