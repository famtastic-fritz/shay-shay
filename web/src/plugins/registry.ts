 ...
 *
 * Plugins call window.__SHAY_PLUGINS__.register(name, Component)
...
export function exposePluginSDK() {
  window.__SHAY_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SHAY_PLUGIN_SDK__ = {
