#!/usr/bin/env python3
"""
SWE Runner with Shay-Shay Trajectory Format

A runner that uses Shay-Shay-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Shay-Shay-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Shay-Shay-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Shay-Shay format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Shay-Shay-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Shay-Shay-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Shay-Shay Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Shay-Shay-Agent's built-in execution environments
    and outputs trajectories in Shay-Shay-Agent format.
    """
    ...
    def _convert_to_shay_format(
        ...
        """
        Convert internal message format to Shay-Shay trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Shay-Shay trajectory format
        trajectory = self._convert_to_shay_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Shay-Shay trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Shay-Shay Trajectory Format")
    print("=" * 60)
