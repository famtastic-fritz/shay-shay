...
Inspired by: GroceryMind — production Shay-Shay doing live web research
             across German grocery stores (firecrawl + shay-shay)
"""
...
# Ensure shay-shay root is on path
...
class WebResearchEnvConfig(ShayAgentEnvConfig):
...
class WebResearchEnv(ShayAgentBaseEnv):
    """
