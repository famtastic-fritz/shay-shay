#!/usr/bin/env python3
"""Build the Shay-Shay Model Catalog — a centralized JSON manifest of curated models.
...
Shay-Shay CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Shay-Shay release.
...
# Ensure SHAY_HOME is set for imports that touch it at module level.
os.environ.setdefault("SHAY_HOME", os.path.join(os.path.expanduser("~"), ".shay"))

from shay_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "shay-shay repo",
            "docs": "https://shay-shay.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
