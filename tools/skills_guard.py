...
Trust levels:
  - builtin:   Ships with Shay-Shay. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.shay/\.env|\~/\.shay/\.env',
     "shay_env_access", "critical", "exfiltration",
     "directly references Shay-Shay secrets file"),
    ...
    (r'\.shay/config\.yaml|\.shay/SOUL\.md',
     "shay_config_mod", "critical", "persistence",
     "references Shay-Shay configuration files directly"),
