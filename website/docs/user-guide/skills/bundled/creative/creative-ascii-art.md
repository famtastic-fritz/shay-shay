...
```bash
python3 -m pyfiglet "SHAY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SHAY&font=Slant" | boxes -d stone
```
