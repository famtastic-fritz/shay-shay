...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateShay-Shay: "Werk Shay-Shay op",
    updatingShay-Shay: "Besig om Shay-Shay op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Shay-Shay-inproppe op (`shay plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.shay/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.shay/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.shay/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Shay-Shay-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Shay-Shay-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Shay-Shay meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Shay-Shay 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Shay-Shay skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
