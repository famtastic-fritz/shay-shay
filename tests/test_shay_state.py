"""Tests for shay_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading Shay-Shay and starting
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from shay_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import sqlite3
        import inspect
        from shay_state import SessionDB as _SessionDB
