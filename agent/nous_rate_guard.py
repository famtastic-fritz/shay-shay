...
(3 SDK retries x 3 Shay-Shay retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".shay")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Shay-Shay, ...) behind one endpoint.  A 429 can mean either:
