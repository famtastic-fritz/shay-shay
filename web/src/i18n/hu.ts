...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateShay-Shay: "Shay-Shay frissítése",
    updatingShay-Shay: "Shay-Shay frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shay-Shay-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `shay plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.shay/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.shay/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.shay/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Shay-Shay-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Shay-Shay munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Shay-Shayt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Shay-Shay kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Shay-Shay egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
