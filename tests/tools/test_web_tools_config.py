...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_shay_home_override(self, tmp_path):
        """Auth lookup should read from SHAY_HOME/auth.json, not ~/.shay/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".shay").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``shay tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
