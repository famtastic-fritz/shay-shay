...
def run_intelligence_loop_slices(
    ...
    """Run slices 2-5 into proposal artifacts and return a closeout packet."""
    ...
    closeout = {
        ...
        "slices": {
            ...
            "3_pointer_promotion_governance": str(artifacts["pointer_candidates"]),
            "4_capability_matrix_reconciliation": str(artifacts["capability_proposals"]),
            "5_session_ambient_context": str(artifacts["session_context"]),
        },
        "counts": {
            "sources": len(sources),
