# Shay-Shay Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.shay/plugins/shay-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.shay/plugins/shay-achievements/scan_checkpoint.json`.
