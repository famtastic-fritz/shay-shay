"""
Skills configuration for Shay-Shay.
`shay skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.shay/config.yaml under:
...
from shay_cli.config import cfg_get, load_config, save_config
from shay_cli.colors import Colors, color
from shay_cli.platforms import PLATFORMS as _PLATFORMS
