...
Same as Shay-Shay but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser (extends Shay2ProToolParser).
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to Shay-Shay, just different tag names.
    """
