"""
ShaySweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser shay
    run-api
    python environments/shay_swe_env.py serve \\
...
class ShaySweEnv(ShayAgentBaseEnv):
    ...
    name = "shay-swe"
    env_config_cls = ShaySweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ShaySweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = ShaySweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepShay-3-Llama-3-3B-Preview",
            tool_call_parser="shay",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="shay-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepShay-3-Llama-3-3B-Preview",
