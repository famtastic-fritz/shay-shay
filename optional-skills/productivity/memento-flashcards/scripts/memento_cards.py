...
Data file: $SHAY_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SHAY_HOME = Path(os.environ.get("SHAY_HOME", Path.home() / ".shay"))
DATA_DIR = _SHAY_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
