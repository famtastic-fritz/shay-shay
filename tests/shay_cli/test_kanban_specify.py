"""Tests for the specifier module + `shay kanban specify` CLI surface.
...
from shay_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `shay kanban …` argparse surface directly."""
