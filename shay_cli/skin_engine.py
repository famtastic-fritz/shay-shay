"""Shay-Shay CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.shay/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Shay-Shay"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Shay-Shay "       # Response box header label
...
.. code-block:: python
    ...
    from shay_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Shay-Shay"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.shay/skins/
...
Drop a YAML file in ``~/.shay/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces SHAY_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces SHAY_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "FAMtastic night — bold red and deep blue",
        "colors": {
            "banner_border": "#FF3366",
            "banner_title": "#FF3366",
            "banner_accent": "#2C5F8D",
            "banner_dim": "#5D6D85",
            "banner_text": "#F7EAF0",
            "ui_accent": "#FF3366",
            "ui_label": "#6EA8D8",
            ...
            "prompt": "#F7EAF0",
            "input_rule": "#2C5F8D",
            "response_border": "#FF3366",
            "status_bar_bg": "#070A12",
            "status_bar_text": "#F7EAF0",
            "status_bar_strong": "#FF3366",
            "status_bar_dim": "#5D6D85",
            "session_label": "#6EA8D8",
            "session_border": "#2C5F8D",
        },
        "spinner": {
            # Empty = use hardcoded defaults in display.py
        },
        "branding": {
            "agent_name": "Shay-Shay",
            "welcome": "Welcome, Shay-Shay! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Shay-Shay ",
            "prompt_symbol": "❯",
