...
| | |
|---|---|
| Source | Optional — install with `shay skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Shay-Shay","productType":"Apparel","tags":["test"]}}'
```
