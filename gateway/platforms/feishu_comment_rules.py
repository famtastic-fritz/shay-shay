...
Config: ~/.shay/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.shay/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_shay_home()`` helper (SHAY_HOME-aware and
...
RULES_FILE = get_shay_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_shay_home() / "feishu_comment_pairing.json"
