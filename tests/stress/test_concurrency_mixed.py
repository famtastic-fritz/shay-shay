...
def worker_loop(worker_id: int, shay_home: str, result_file: str) -> None:
...
def reclaimer_loop(shay_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="shay_mixed_stress_")
    print(f"SHAY_HOME = {home}")
