#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Shay-Shay docs site.
...
Both publish at:
  https://shay-shay.nousresearch.com/docs/llms.txt
  https://shay-shay.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://shay-shay.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Shay-Shay as a Python Library", None),
        ("guides/use-mcp-with-shay", "Use MCP with Shay-Shay", None),
        ("guides/use-voice-mode-with-shay", "Use Voice Mode with Shay-Shay", None),
        ("guides/use-soul-with-shay", "Use SOUL.md with Shay-Shay", None),
        ("guides/build-a-shay-plugin", "Build a Shay-Shay Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Shay-Shay"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "shay-shay/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/shay-shay")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Shay-Shay — Full Documentation\n",
        (
            "This file is the entire Shay-Shay documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Shay-Shay, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://shay-shay.nousresearch.com/docs\n",
        "Short index: https://shay-shay.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
