"""
ShayAgentLoop -- Reusable Multi-Turn Agent Engine

Runs the shay-shay tool-calling loop using standard OpenAI-spec tool calling.
...
identical to shay-shay's run_agent.py. Tool execution is dispatched via
...
# Resized at runtime by ShayAgentBaseEnv.__init__ via resize_tool_pool().
...
def resize_tool_pool(max_workers: int):
    ...
    Called by ShayAgentBaseEnv.__init__ based on config.tool_pool_size.
...
class ShayAgentLoop:
    """
    Runs shay-shay's tool-calling loop using standard OpenAI-spec tool calling.
    ...
    async def run(self, messages: List[Dict[str, Any]]) -> AgentResult:
        ...
        for turn in range(self.max_turns):
            ...
            # shay-shay's standalone parsers. This handles the case where
            ...
            if (
                ...
                try:
                    ...
                    fallback_parser = get_parser("shay")
            ...
            if assistant_msg.tool_calls:
                ...
                # Execute each tool call via shay-shay's dispatch
