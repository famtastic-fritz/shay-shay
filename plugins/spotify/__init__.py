...
``_check_spotify_available()`` — when the user has not run ``shay auth
spotify``, the tools remain registered (so they appear in ``shay
...
The Spotify auth flow (``shay auth spotify``), CLI plumbing, and docs
