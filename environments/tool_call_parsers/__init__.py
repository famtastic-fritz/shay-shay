...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("shay")
        class ShayToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "shay", "mistral", "llama3_json")
...
from environments.tool_call_parsers.shay_parser import ShayToolCallParser  # noqa: E402, F401
