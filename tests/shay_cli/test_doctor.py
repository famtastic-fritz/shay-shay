...
import shay_cli.doctor as doctor
import shay_cli.gateway as gateway_cli
from shay_cli import doctor as doctor_mod
from shay_cli.doctor import _has_provider_env_config
...
class TestDoctorEnvFileEncoding:
    """Regression for #18637 (bug 3): `shay doctor` crashed on Windows
    ...
    def test_doctor_reads_env_as_utf8_even_when_locale_is_not_utf8(
        ...
        monkeypatch.setattr(doctor_mod, "SHAY_HOME", shay_home)
...
class TestDoctorToolAvailabilityOverrides:
    ...
    def test_leaves_kanban_unavailable_when_worker_env_is_set(self, monkeypatch):
        monkeypatch.setenv("SHAY_KANBAN_TASK", "probe")
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    def fake_check_tool_availability(*args, **kwargs):
        seen["interactive"] = os.getenv("SHAY_INTERACTIVE")
        raise SystemExit(0)
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_shay_home(self, tmp_path, provider=""):
        """Create a minimal SHAY_HOME with config.yaml."""
        home = tmp_path / ".shay"
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_shay_home(tmp_path, provider)
...
def test_run_doctor_accepts_shay_provider_ids_that_catalog_aliases(
...
class TestGitHubTokenCheck:
    ...
    def test_no_token_and_not_gh_authenticated_shows_warn(self, monkeypatch, tmp_path):
        ...
        from shay_cli.doctor import run_doctor, _DHH
        import io, contextlib
