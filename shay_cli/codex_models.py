...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # in shay_cli/models.py — only the openai-codex (OAuth) provider
...
_FORWARD_COMPAT_TEMPLATE_MODELS: List[tuple[str, tuple[str, ...]]] = [
    ...
    # entitlement; Shay-Shay does not.
...
def _read_cache_models(codex_home: Path) -> List[str]:
    ...
    if isinstance(entries, list):
        for item in entries:
            ...
            # public OpenAI API, while Shay-Shay openai-codex talks to the same
