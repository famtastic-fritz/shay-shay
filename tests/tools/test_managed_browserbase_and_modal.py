...
def _enable_managed_nous_tools(monkeypatch):
    ...
    shay_cli.auth and shay_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("shay_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("shay_cli.models.check_nous_free_tier", lambda: False)
