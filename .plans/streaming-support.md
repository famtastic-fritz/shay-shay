# Streaming LLM Response Support for Shay-Shay
...
```
SHAY_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SHAY_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `shay_cli/config.py` | 1 | +streaming config defaults |
