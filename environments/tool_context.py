...
ALL shay-shay tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all shay-shay tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any shay-shay tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("SHAY_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("SHAY_QUIET", None)
            else:
                os.environ["SHAY_QUIET"] = _prev_quiet
