...
const config: Config = {
  ...
  url: 'https://shay-shay.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'shay-shay',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/shay-shay/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/shay-shay-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://shay-shay.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/NousResearch/shay-shay',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/NousResearch/shay-shay/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/NousResearch/shay-shay' },
