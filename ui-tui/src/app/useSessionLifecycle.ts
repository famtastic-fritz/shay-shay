...
import type { ScrollBoxHandle } from '@shay/ink'
import { evictInkCaches } from '@shay/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SHAY_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
