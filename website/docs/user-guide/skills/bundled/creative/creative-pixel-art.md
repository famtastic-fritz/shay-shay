...
```python
import sys
sys.path.insert(0, "/home/teknium/.shay/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.shay/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Shay-Shay installs package this)
