"""
Monkey patches for making shay-shay tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by shay_base_env.py).
