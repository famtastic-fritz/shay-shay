...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateShay-Shay: "Aggiorna Shay-Shay",
    updatingShay-Shay: "Aggiornamento di Shay-Shay…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Shay-Shay (parità con `shay plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.shay/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.shay/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.shay/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Shay-Shay da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Shay-Shay in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Shay-Shay di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Shay-Shay rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Shay-Shay sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
