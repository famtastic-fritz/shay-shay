...
def test_import_loads_env_from_shay_home(tmp_path, monkeypatch):
    home = tmp_path / ".shay"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-shay-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-shay-home"
