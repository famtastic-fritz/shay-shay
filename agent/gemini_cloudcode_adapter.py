...
This adapter lets Shay-Shay use the ``google-gemini-cli`` provider as if it were
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "shay-shay (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/shay",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Shay-Shay issue). Try a different Gemini model or set a "
        ...
        message = (
            ...
            f"retired. Check shay_cli/models.py for the current list."
        )
    elif err_message:
