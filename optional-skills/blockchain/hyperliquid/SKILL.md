...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Shay-Shay
license: MIT
...
The script reads `~/.shay/.env` for two optional defaults:
...
Helper script: `~/.shay/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.shay/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.shay/.env`.
...
```bash
python3 ~/.shay/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.shay/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
