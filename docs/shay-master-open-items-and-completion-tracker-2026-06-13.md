...
|---|---|---|---|---|---|---|---|---|---|
| MSI-001 | Mission amendment to HyperSwarm model | pr_ready | Mission amendment exists as a separate control-plane addendum without rewriting original mission authority | Fritz | no | local-only until committed with tracker pack | `docs/shay-full-autonomy-completion-mission-amendment-2026-06-13.md` | no | commit with tracker pack |
| MSI-002 | Hermes lane packet | pr_ready | Hermes status classified with designed vs live separation and proof pointers | Fritz | no | uncommitted working tree | `docs/shay-hermes-lane-packet-2026-06-13.md` | no | merge into final packet |
...
| MSI-009 | Adoption backlog | designed | Structured backlog exists with owner/reason/priority model | Fritz | no | not yet connected to recurring review loop | `docs/shay-adoption-backlog-2026-06-13.md` | no | bind to future review cycle |
| MSI-010 | Gap lifecycle status | designed | Gap classes and lifecycle states documented | Fritz | no | not machine-written | `docs/shay-gap-lifecycle-status-2026-06-13.md` | no | connect to tracker/ledger |
...
| MSI-012 | Run ledger schema | pr_ready | YAML schema exists and the runtime now writes real run records automatically | captain | no | branch-local until pushed/merged | `docs/shay-run-ledger-schema-2026-06-13.yaml`, `process_intelligence.py` | partial | push and validate on shared branch |
...
| MSI-014 | Tool-agent ledger schema | pr_ready | YAML schema exists and the runtime now writes real tool activity records | captain | no | branch-local until pushed/merged | `docs/shay-tool-agent-ledger-schema-2026-06-13.yaml`, `process_intelligence.py` | partial | push and validate on shared branch |
| MSI-015 | Artifact ledger schema | pr_ready | YAML schema exists and the runtime now writes artifact records from touched paths | captain | no | branch-local until pushed/merged | `docs/shay-artifact-ledger-schema-2026-06-13.yaml`, `process_intelligence.py` | partial | push and validate on shared branch |
...
| MSI-031 | Real ledger pipeline | sandbox_proven | Machine-written run/tool/artifact/validation records emitted during real Shay runs in the branch-local Phase 1 runtime slice | Fritz | yes | not yet pushed/merged; decision ledger still missing | `process_intelligence.py`, `tests/test_process_intelligence.py` | partial | promote branch and then extend to decision ledger |
...
1. Phase 1 runtime exists only on this branch; it is not yet pushed/merged.
2. Tracker and some lane artifacts are still uncommitted.
3. Awareness snapshot is stale in places after later lane outputs landed.
...
6. Pattern scanner is now designed but still not implemented.
